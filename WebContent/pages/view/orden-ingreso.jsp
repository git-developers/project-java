...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
        <div class="header">
            <h2>
                <i class="material-icons">add_shopping_cart</i> Orden ingreso mercaderia
             	...
             	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                      <div class="form-group">
                          <div class="form-line">
                              <input type="text" name="form_remitente" class="form-control" placeholder="Remitente" required="required">
                          </div>
                      </div>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                      <div class="form-group">
                          <div class="form-line">
                              <input type="date" name="form_fecha_recibido" class="form-control" placeholder="Fecha recibido" required="required">
                          </div>
                      </div>
                  </div>
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
...
<script src="assets/js/orden-ingreso/productos.js"></script>
<script src="assets/js/orden-ingreso/add-producto.js"></script>
<script src="assets/js/orden-ingreso/register.js"></script>
<script src="assets/js/orden-ingreso/edit-producto-cantidad.js"></script>
