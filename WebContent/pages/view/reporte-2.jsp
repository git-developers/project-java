 ...
 <div class="row clearfix">
	...
	<div class="card">
	    ...
	    <div class="body"><iframe class="chartjs-hidden-iframe" style="width: 100%; display: block; border: 0px; height: 0px; margin: 0px; position: absolute; left: 0px; right: 0px; top: 0px; bottom: 0px;"></iframe>
	     <canvas id="bar_chart" height="282" width="565" style="display: block; width: 565px; height: 282px;"></canvas>
	        </div>
	    </div>
	</div>
    <!-- #END# Line Chart -->
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body"><iframe class="chartjs-hidden-iframe" style="width: 100%; display: block; border: 0px; height: 0px; margin: 0px; position: absolute; left: 0px; right: 0px; top: 0px; bottom: 0px;"></iframe>
                <canvas id="pie_chart" height="282" width="565" style="display: block; width: 565px; height: 282px;"></canvas>
            </div>
        </div>
    </div>
