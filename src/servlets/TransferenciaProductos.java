 ...
 */
@WebServlet("/transferencia-productos")
public class TransferenciaProductos extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(usuario != null){
			getServletContext().getRequestDispatcher("/pages/view/transferencia-productos.jsp").forward(request, response);
		}else{
